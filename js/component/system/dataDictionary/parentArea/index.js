...
import AddParentArea from "./addParentArea";

// import EditEventCategory from "./editCategory";
import './parentArea.less';
...
export default class ParentArea extends Component{
    constructor(props){
        super(props)
        this.state={
            // editLoading: false,
        ...
        return (
            <div className='data-class-over'>
                ...
                <div>
                    ...
                    <AddParentArea addVisible = {this.state.addVisible}/>
